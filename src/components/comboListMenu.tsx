...
interface IComboListMenuProps {
  editHandler: (event: any) => void;
  deleteHandler: (event: any) => void;
}

export default function ComboListMenu({
  editHandler,
  deleteHandler,
}: IComboListMenuProps) {
  return (
    <div className="w-full text-right">
      ...
      >
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md border border-white bg-transparent px-3 py-2 text-sm font-medium text-white hover:bg-white/10 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            <EllipsisHorizontalIcon
